      ...
      <div className="space-y-6">
        <Card className="border-none shadow-soft bg-white dark:bg-slate-950">
          ...
          <CardContent className="space-y-8 p-6">
            ...
            <Card className="bg-blue-50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-800/20 shadow-sm">
              <CardContent className="p-6">
                <h3 className="font-bold text-lg text-blue-700 dark:text-blue-300 mb-2">Congratulations!</h3>
