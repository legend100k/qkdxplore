export const QuantumHardware = () => {
  return (
    <div className="prose max-w-none p-8">
      ...
      <img src="src/components/photon-encoder.jpg" className="w-1/4 h-1/4 mx-auto flex justify-left"></img>
      ...
      <img src="src/components/quantumChannelPhoto.jpeg" className="w-1/4 h-1/4 mx-auto flex justify-left"></img>
      ...
      <img src="src/components/beamSpliiter.png" className="w-1/4 h-1/4 mx-auto flex justify-left"></img>
      ...
      <img src="src/components/SPAD.jpeg" className="w-1/4 h-1/4 mx-auto flex justify-left"></img>
